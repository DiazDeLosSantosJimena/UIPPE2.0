...
class UsuariosSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $usuario->clave = 'URS2';
        $usuario->nombre = 'Administrador';
        $usuario->app = 'Plataforma';
        $usuario->apm = 'SIPPyEM';
        $usuario->gen = 'M';
        $usuario->fn = '2001-01-01';
        $usuario->academico = 'SIPPyEM';
        $usuario->foto = 'cuervo.png';
        $usuario->email = 'plataforma@sippyem.com';
        $usuario->password = 'adminP';
        $usuario->id_tipo = '2';
        $usuario->activo = '1';
        $usuario->id_registro = '1';
        $usuario->save();
        ...
        $usuario->academico = 'SIPPyEM';
        $usuario->foto = 'cuervo.png';
        $usuario->email = 'area@sippyem.com';
        $usuario->password = 'encargadoA';
        $usuario->id_tipo = '3';
        $usuario->activo = '1';
        $usuario->id_registro = '1';
        $usuario->save();
        ...
        $usuario->academico = 'SIPPyEM';
        $usuario->foto = 'cuervo.png';
        $usuario->email = 'secretari@sippyem.com';
        $usuario->password = 'secreArea';
        $usuario->id_tipo = '4';
        $usuario->activo = '1';
        $usuario->id_registro = '1';
        $usuario->save();
        ...
        $usuario->academico = 'SIPPyEM';
        $usuario->foto = 'cuervo.png';
        $usuario->email = 'invitad@sippyem.com';
        $usuario->password = 'invitado';
        $usuario->id_tipo = '5';
        $usuario->activo = '1';
        $usuario->id_registro = '1';
        $usuario->save();
