...
<div class="container p-4">
    ...
    <div class="row">
        ...
        @auth <!-- Contenido para verificar sesión iniciada -->
        @if(auth()->user()->id_tipo == 1 || auth()->user()->id_tipo == 2 || auth()->user()->id_tipo == 3) <!-- Contenido dependiendo del tipo de usuario -->
        <div class="col-md-12">
