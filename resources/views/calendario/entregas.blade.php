...
@auth    <!-- Validacion de contenido LOGGEADO -->
@if(auth()->user()->id_tipo == 1 || auth()->user()->id_tipo == 2 || auth()->user()->id_tipo == 3 || auth()->user()->id_tipo == 4)   <!-- Validacion de contenido POR TIPO DE USUARIO IF -->
...
@endif
@endauth
<!-- Validacion de contenido LOGGEADO -->
@guest
<div class="container p-4">
    <div class="row">
        <div class="col p-4">
